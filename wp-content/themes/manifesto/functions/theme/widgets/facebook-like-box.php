...
<?php
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' => 'Like us on Facebook', 'pageurl' => 'http://www.facebook.com/wpzoom', 'width' => 280, 'bordercolor' => 'e6e2dc', 'show_faces' => 'on', 'show_stream' => 'off', 'show_header' => 'off' );
			...
			<p>
				...
				<small>* Default: <strong>280</strong> </small>
			</p>
			<p>
