...
add_image_size( 'homepage-slider', 600, 300, true );
add_image_size( 'featured-category-widget', 280, 160, true );
add_image_size( 'loop-main', 160, 120, true );
add_image_size( 'featured-categories', 140, 90, true );
...
/*----------------------------------*/
/* Fix Links widget no-title bug	*/
/*----------------------------------*/

// add_filter ('wp_list_bookmarks', 'wpzoom_fix_blogroll');

function wpzoom_fix_blogroll($content) { 
