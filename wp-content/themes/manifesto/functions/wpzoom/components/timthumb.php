...
if(! isset($ALLOWED_SITES)){
    $ALLOWED_SITES = array (
        ...
        'imageshack.us',
        'tinypic.com',
        'ytimg.com', // Used for Automatic Video Thumbnails in specific theems
        'vimeocdn.com', // Used for Automatic Video Thumbnails in specific theems
        'wpzoom.com', // Useful when installing the XML file with samle content from theme's demo page
        'demo.wpzoom.com'  // Useful when installing the XML file with samle content from theme's demo page
    );
...
class timthumb {
    ...
    public function __construct(){
        ...
        if(BLOCK_EXTERNAL_LEECHERS && array_key_exists('HTTP_REFERER', $_SERVER) && (! preg_match('/^https?:\/\/(?:www\.)?' . $this->myHost . '(?:$|\/)/i', $_SERVER['HTTP_REFERER']))){
            $imgData = file_get_contents(dirname(__FILE__) . '/../assets/images/hotlink.gif');
