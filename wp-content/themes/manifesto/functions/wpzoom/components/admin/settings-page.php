...
class WPZOOM_Admin_Settings_Page {
    ...
    public static function contextual_help() {
        ...
        '<p>' . __( '<a href="http://www.wpzoom.com/support/documentation" target="_blank">Documentation and Tutorials</a>', 'twentyeleven' ) . '</p>' .
        '<p>' . __( '<a href="http://www.wpzoom.com/forum/" target="_blank">Support Forums</a>', 'twentyeleven' ) . '</p>';
